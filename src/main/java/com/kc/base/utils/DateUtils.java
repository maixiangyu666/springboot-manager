...
public class DateUtils {
  ...
  * @return 返回时间类型 yyyy-MM-dd HH:mm:ss
  */
 public static String getNowTime(String formater) {
  Date currentTime = new Date();
  ...
  */
 public static String getNowStartYear() {
  Date currentTime = new Date();
  SimpleDateFormat formatter = new SimpleDateFormat("yyyy");
  String dateString = formatter.format(currentTime);
...
//  ParsePosition pos = new ParsePosition(8);
  ...
  * @return返回字符串格式 yyyy-MM-dd HH:mm:ss
  */
 public static String getStringDate(String formatstr) {
  Date currentTime = new Date();
  ...
  * @return 返回短时间字符串格式yyyy-MM-dd
  */
 public static String getStringDateShort(String formatstr) {
  Date currentTime = new Date();
  SimpleDateFormat formatter = new SimpleDateFormat(formatstr);
  String dateString = formatter.format(currentTime);
  return dateString;
 ...
 public static Date parseDate(String strDate,String strformatter){
 ...
 public static String parseString(String strDate,String strformatter){
	 SimpleDateFormat formatter = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
	 SimpleDateFormat tostrformatter = new SimpleDateFormat(strformatter);
	  ParsePosition pos = new ParsePosition(0);
	  if(strDate!=null)
	  {
		  Date strtodate = formatter.parse(strDate, pos);
		  ...
		  return tostrformatter.format(strtodate);
	  }
	  return null;
 }
 /**
  ...
  * 得到二个日期间的间隔天数
  */
 public static String getNowBeDay(String oldtime, String formatter) {
  SimpleDateFormat myFormatter = new SimpleDateFormat(formatter);
  long day = 0;
  try {
   Date mydate = myFormatter.parse(oldtime);
   Date date = myFormatter.parse(myFormatter.format(new Date()));
   day = (date.getTime() - mydate.getTime()) / (24 * 60 * 60 * 1000);
  } catch (Exception e) {
   return "";
  }
  ...
  * 得到二个日期间的间隔天数
  */
 public static Integer getNowBeDay(String oldtime) {
  SimpleDateFormat myFormatter = new SimpleDateFormat("yyyy-MM-dd");
  Long day = 0l;
  try {
   Date mydate = myFormatter.parse(oldtime);
  ...
  * @return
  */
 public static long getTime(String date1, String date2) {
  if (date1 == null || date1.equals(""))
   return 0;
  if (date2 == null || date2.equals(""))
   return -1;
 ...
 public static String getNowTimeMonthAddOne(){
	 Calendar cal = Calendar.getInstance();
	 Date currentTime = new Date();
 ...
 public static String getDateAdd(String date,String day) throws ParseException{
	 Calendar cal = Calendar.getInstance();
	 SimpleDateFormat formatter = new SimpleDateFormat("yyyy-MM-dd");
